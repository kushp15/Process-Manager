...
class MainWindow(QtWidgets.QMainWindow, Ui_Form):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(resource_path('Images/Icon.jpg')))
        ...
        with open('TextFile/PathText.txt', 'r+') as file:
            ...
            if path:
                ...
                self.application_path = 'Enter Path'
    ...
    def check_application_running(self):
        for process in gw.getAllTitles():
            if 'Your Application Title' in process:
                print(process)
                return True
        return False
    ...
    def start_application(self):
        try:
            ...
            time.sleep(5)
            windows = gw.getWindowsWithTitle('Your Application Title')
            if windows:
                window = windows[0]
                window.maximize()
        except Exception:
